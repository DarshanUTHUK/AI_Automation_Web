...
from recording_hook.api import Api
...
async def runserver():
    ...
    print("Successfully server started")

async def send_agent_history_step(data):
    """Send the agent step data to the recording API"""
    url = "http://localhost:8080/post_agent_history_step"
